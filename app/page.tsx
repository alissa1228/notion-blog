    ...
    <section>
      ...
      <div className="flex justify-between border-t-2 border-black">
        <div className="text-center w-[50%] py-8">
          ...
          <Link  href="/resume">
              <Button className="mt-4 bg-black text-white rounded-lg px-3 py-2 transition-all ease-linear hover:bg-[#d5bfff] hover:text-black">궁금해요 💭</Button>
          </Link>
        </div>
        ...
        <h3 className="text-xl font-bold tracking-tight text-center">저는 이런 글을 썼어요 📝 </h3>
          <Link  href="/blog">
              <Button className="mt-4 bg-black text-white rounded-lg px-3 py-2 transition-all ease-linear hover:bg-[#d5bfff] hover:text-black">보러가기 🔍</Button>
          </Link>
        </div>
        </div>
    </section>
